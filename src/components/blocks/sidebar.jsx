...
// shadcn-style sidebar primitives, kept under components/blocks (not
// components/ui) because this project already has a different Sidebar
// component (Aceternity-style) at components/ui/sidebar.jsx. The two are
// unrelated APIs and must not collide.
...
export const SidebarMenuSubButton = forwardRef(({ asChild = false, size = 'md', isActive, className, ...props }, ref) => {
