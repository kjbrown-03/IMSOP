    ...
    <div className="bg-[var(--color-bg)] text-[var(--color-text-main)] antialiased font-body-md overflow-x-hidden min-h-screen transition-colors duration-300">
      ...
      <main className="pt-16 pb-28 md:pb-0">
        ...
        <section className="max-w-[1000px] mx-auto px-margin-mobile md:px-margin-desktop py-stack-lg grid grid-cols-1 md:grid-cols-2 gap-gutter">
          <div className="bg-[var(--color-surface)] border border-[var(--color-border)] rounded-xl p-6 shadow-sm dark:bg-neutral-900">
            <div className="w-12 h-12 rounded-full bg-[var(--color-primary-container)] text-[var(--color-on-primary-container)] flex items-center justify-center mb-4">
              <span className="material-symbols-outlined">person_add</span>
            </div>
            <h2 className="font-headline-md text-headline-md text-[var(--color-text-main)] mb-2">{t('public.forDoctors.doctorsTitle')}</h2>
            <p className="font-body-md text-body-md text-[var(--color-text-secondary)] mb-4">
              {t('public.forDoctors.doctorsText')}
            </p>
            <ul className="space-y-2 font-body-md text-body-md text-[var(--color-text-main)]">
              <li className="flex items-start gap-2">
                <span className="material-symbols-outlined text-[var(--color-secondary)] text-[18px] mt-0.5">check_circle</span>
              ...
              <li className="flex items-start gap-2">
                <span className="material-symbols-outlined text-[var(--color-secondary)] text-[18px] mt-0.5">check_circle</span>
                {t('public.forDoctors.doctorsItem3')}
              </li>
            </ul>
          </div>
          ...
          <div className="bg-[var(--color-surface)] border border-[var(--color-border)] rounded-xl p-6 shadow-sm dark:bg-neutral-900">
            ...
            <h2 className="font-headline-md text-headline-md text-[var(--color-text-main)] mb-2">{t('public.forDoctors.specialistsTitle')}</h2>
            <p className="font-body-md text-body-md text-[var(--color-text-secondary)] mb-4">
