      ...
      <main className="flex-1 w-full max-w-7xl mx-auto pt-20 pb-28 md:py-12 px-4 sm:px-6 flex flex-col animate-fade-in">
        ...
        <div className="mb-10 w-full max-w-3xl mx-auto">
          <div className="flex items-center justify-between relative">
            ...
            <div className="relative z-10 flex flex-col items-center">
              <div className="w-10 h-10 rounded-full bg-white dark:bg-neutral-800 text-slate-400 dark:text-slate-500 border border-slate-200 dark:border-neutral-700 flex items-center justify-center font-bold shadow-sm">
                3
              </div>
              <span className="mt-3 font-semibold text-xs uppercase tracking-wider text-slate-400 dark:text-slate-500 hidden md:block">
        ...
        <div className="flex-1 max-w-3xl mx-auto w-full">
          <div className="glass-card rounded-3xl p-6 sm:p-8 shadow-sm">
            <h2 className="text-xl font-bold text-slate-900 dark:text-white mb-8 flex items-center gap-3 border-b border-slate-100/60 dark:border-neutral-700 pb-4">
               <FileText className="w-6 h-6 text-primary-600 dark:text-primary-400" /> {t('patient.questionnaire.formTitle')}
            </h2>
            ...
            <form className="flex flex-col gap-8" onSubmit={onSubmit} id="questionnaire-form">
              <div className="flex flex-col gap-2.5">
                <label className="font-bold text-sm text-slate-900 dark:text-white" htmlFor="specialite">
                  {t('patient.questionnaire.specialiteLabel')} <span className="text-rose-500 dark:text-rose-400">*</span>
                </label>
                <div className="relative">
                  ...
                  <ChevronDown className="absolute right-4 top-1/2 -translate-y-1/2 pointer-events-none text-slate-400 dark:text-slate-500 w-5 h-5" />
                </div>
              </div>

              <div className="flex flex-col gap-2.5">
                <label className="font-bold text-sm text-slate-900 dark:text-white" htmlFor="motif">
                  {t('patient.questionnaire.motifLabel')} <span className="text-rose-500 dark:text-rose-400">*</span>
                </label>
                <div className="relative">
                  <select
                    className="w-full bg-slate-50 dark:bg-neutral-800 border border-slate-200/60 dark:border-neutral-700 rounded-xl px-4 py-3.5 text-sm font-medium text-slate-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-primary-500/20 focus:border-primary-500 transition-all appearance-none cursor-pointer hover:bg-white dark:hover:bg-neutral-700"
              ...
              <div className="flex flex-col gap-2.5">
                <label className="font-bold text-sm text-slate-900 dark:text-white" htmlFor="symptomes">
                  {t('patient.questionnaire.symptomesLabel')} <span className="text-rose-500 dark:text-rose-400">*</span>
                </label>
                <textarea
                  className="w-full bg-slate-50 dark:bg-neutral-800 border border-slate-200/60 dark:border-neutral-700 rounded-xl px-4 py-3.5 text-sm font-medium text-slate-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-primary-500/20 focus:border-primary-500 transition-all resize-y placeholder:text-slate-400 dark:placeholder:text-slate-500 hover:bg-white dark:hover:bg-neutral-700 min-h-[120px]"
                  id="symptomes"
                  ...
                  {['oui', 'non'].map((val) => (
                    <button
                      ...
                      className={`rounded-xl p-4 text-center font-bold text-sm capitalize transition-all border shadow-sm ${
                        antecedents === val
                          ? 'bg-primary-50 dark:bg-primary-900/30 border-primary-500 text-primary-700 dark:text-primary-400 shadow-primary-900/5'
                          : 'bg-slate-50 dark:bg-neutral-800 border-slate-200/60 dark:border-neutral-700 text-slate-700 dark:text-slate-300 hover:bg-white dark:hover:bg-neutral-700'
                      }`}
                    >
              ...
              <div className="flex flex-col gap-2.5">
                <label className="font-bold text-sm text-slate-900 dark:text-white" htmlFor="traitement">
